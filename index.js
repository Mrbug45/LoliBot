...
const start = async (client = new Client()) => {
        ...
        client.onAddedToGroup(((chat) => {
            ...
            if (totalMem < 30) { 
                ...
                client.sendText(chat.groupMetadata.id, `Halo warga grup *${chat.contact.name}* terimakasih sudah menginvite bot ini waktu : *${moment().utcOffset('+0700').format('HH:mm')}*\nuntuk melihat menu silahkan kirim *!help*`)
            }
        }))
